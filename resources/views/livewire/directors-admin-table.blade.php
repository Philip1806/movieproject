<div>
    <div class="row my-2">
        ...
        <div class="col-sm-3">
            <input type="text" wire:model="search" class="form-control" placeholder="Търсене на режисьор">
        </div>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="text-right align-middle">
                            ...
                            <div class="d-inline-block">
                                <button type="button" wire:click="deleteId({{ $director->id }})"
                                    class="btn btn-danger" data-toggle="modal" data-target="#exampleModal"><i
